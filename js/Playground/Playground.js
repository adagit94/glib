...
class Playground extends Shader {
        ...
        await this.init([
            {
                ...
                buffersData: {
                    geometry: {
                        vertices: [light.locations.position, geometry.vertices],
                        indices: geometry.indices,
                        normals: [light.locations.normal, geometry.normals],
                        textureCoords: [light.locations.textureCoords, geometry.textureCoords],
                    },
                },
            },
        ]);

        await this.createTexture("lightImg", "print-screens/light/Screenshot 2022-06-05 132133.png")
    ...
    renderScene = () => {
        const backPlaneMat = ShaderUtils.mult3dMats(ShaderUtils.init3dTranslationMat(-0.4, 0.4, -0.4), ShaderUtils.init3dRotationMat("x", -Math.PI / 2));
