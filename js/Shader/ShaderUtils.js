export default class ShaderUtils {
  ...
  static createShaderProgram = async (gl, paths) => {
    let shadersFetches = [];

    shadersFetches.push(fetch(paths.vShader, ShaderUtils.#shaderFetchConf));
    shadersFetches.push(fetch(paths.fShader, ShaderUtils.#shaderFetchConf));
  ...
  static createAndBindVerticesBuffer(
    gl,
    attrLocation,
    bufferData,
    settings,
    ...
    gl.bufferData(gl.ARRAY_BUFFER, bufferData, drawMethod);
  ...
  createAndBindIndicesBuffer(gl, bufferData, drawMethod = gl.STATIC_DRAW) {
    const buffer = gl.createBuffer();

    gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, buffer);
    gl.bufferData(gl.ELEMENT_ARRAY_BUFFER, bufferData, drawMethod);
